...
namespace MakeBot
{
    ...
    public partial class Main : Window
    {
        ...
        private readonly string compilerExecutable;
        ...
        public Main(string[] args)
        {
            ...
            compilerExecutable = ResolveCompilerExecutable();
        ...
        /// <summary>
        /// Resolve the TWX compiler path for the current environment.
        /// </summary>
        /// <returns>Compiler executable name or absolute path.</returns>
        private string ResolveCompilerExecutable()
        {
            var overridePath = Environment.GetEnvironmentVariable("TWXC_PATH");
