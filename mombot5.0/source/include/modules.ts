...
if (($PLAYER~LIMPETS <= 0) and (($MODULES~LIMPETOWNER <> "belong to your Corp") and ($MODULES~LIMPETOWNER <> "yours")))
  setvar $SWITCHBOARD~MESSAGE "Need limpets to clear this sector*"
  return
end
if (($PLAYER~ARMIDS <= 0) and (($MODULES~ARMIDOWNER <> "belong to your Corp") and ($MODULES~ARMIDOWNER <> "yours")))
  setvar $SWITCHBOARD~MESSAGE "Need armids to clear this sector*"
  return
end
if ((($MODULES~LIMPETOWNER = "belong to your Corp") or ($MODULES~LIMPETOWNER = "yours")) and (($MODULES~ARMIDOWNER = "belong to your Corp") or ($MODULES~ARMIDOWNER = "yours")))
