...
if (($USER_INTERFACE~CHARACTER = ">") and ($BOT~CHARCOUNT <= 0))
  ...
  if (SECTOR.WARPS[CURRENTSECTOR][$USER_INTERFACE~SECTOR] > 0)
    ...
    elseif ($PLAYER~CURRENT_PROMPT = "Command")
      setvar $PLAYER~MOVEINTOSECTOR SECTOR.WARPS[CURRENTSECTOR][$USER_INTERFACE~SECTOR]
...
while ($USER_INTERFACE~B <= $BOT~COMMAND_LINES)
  ...
  savevar $SWITCHBOARD~SELF_COMMAND
  if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "?")
    setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "help"
  end
  ...
  if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "l")
    setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "land"
  end
  if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "x")
    setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "xport"
  end
  if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "qss")
    setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "status"
  end
  if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "d")
    setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "dep"
  end
  if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "w")
    setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "with"
  end
  if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "k")
    setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "keep"
  end
  if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "exit")
    setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "xenter"
  end
  if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "cn")
    setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "cn9"
  end
  if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "emx")
    setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "reset"
  end
  if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "pinfo")
    setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "pscan"
  end
  if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "shipstore")
    setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "storeship"
  end
  ...
  if ($USER_INTERFACE~POS > 0)
    if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "m")
      setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "mow"
    end
    if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "p")
      setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "pwarp"
    end
    if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "t")
      setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "twarp"
    end
    if ($BOT~COMMAND_LINES[$USER_INTERFACE~B][9] = "b")
      setvar $BOT~COMMAND_LINES[$USER_INTERFACE~B][9] "bwarp"
    end
  ...
  while ($USER_INTERFACE~J <= 7)
    if ($USER_INTERFACE~I = 3)
      ...
      if ($USER_INTERFACE~DOESEXIST or $USER_INTERFACE~DOESEXISTHIDDEN)
        ...
        setvar $HELP~CURRENTLIST $BOT~INTERNALCOMMANDLIST[$USER_INTERFACE~J]
        return
      end
    else
