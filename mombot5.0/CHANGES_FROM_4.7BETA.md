# Mombot 5.0 beta1 Changes From 4.7beta
...
5.0 beta1 version state:

- `$bot~major_version = "5"`
- `$bot~minor_version = "0beta1"`

5.0 also adds:

- `$bot~default_bot_directory = "mombot"`
- `scripts/mombot5_0beta1.cfg`, which stores the selected Mombot directory name
...
- Version changed from `4.01p` to `5.0beta1`.
- Startup now chooses a configurable Mombot directory through `scripts/mombot5_0beta1.cfg`.
