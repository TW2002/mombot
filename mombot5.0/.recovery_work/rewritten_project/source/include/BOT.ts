...
makedir "scripts/"&$BOT~MOMBOT_DIRECTORY&"/games"
setvar $BOT~FOLDER "scripts/"&$BOT~MOMBOT_DIRECTORY&"/games/"&GAMENAME
makedir $BOT~FOLDER

setvar $BOT~HOTKEYS_FILE "scripts/"&$BOT~MOMBOT_DIRECTORY&"/hotkeys.cfg"
setvar $BOT~CUSTOM_KEYS_FILE "scripts/"&$BOT~MOMBOT_DIRECTORY&"/custom_keys.cfg"
setvar $BOT~CUSTOM_COMMANDS_FILE "scripts/"&$BOT~MOMBOT_DIRECTORY&"/custom_commands.cfg"

gosub :MENUS~DOSPLASHSCREEN
fileexists $BOT~EXISTS1 $BOT~HOTKEYS_FILE
fileexists $BOT~EXISTS2 $BOT~CUSTOM_KEYS_FILE
fileexists $BOT~EXISTS3 $BOT~CUSTOM_COMMANDS_FILE
if ($BOT~EXISTS1 and ($BOT~EXISTS2 and $BOT~EXISTS3))
  readtoarray $BOT~HOTKEYS_FILE $BOT~HOTKEYS
  readtoarray $BOT~CUSTOM_KEYS_FILE $BOT~CUSTOM_KEYS
  readtoarray $BOT~CUSTOM_COMMANDS_FILE $BOT~CUSTOM_COMMANDS
end

gosub :COMBAT~INIT

if (($BOT~EXISTS1 = FALSE) or ($BOT~EXISTS2 = FALSE) or ($BOT~EXISTS3 = FALSE) or ($BOT~HOTKEYS <> 255) or ($BOT~CUSTOM_KEYS <> 33) or ($BOT~CUSTOM_COMMANDS <> 33))
  delete $BOT~HOTKEYS_FILE
  delete $BOT~CUSTOM_KEYS_FILE
  delete $BOT~CUSTOM_COMMANDS_FILE
  setarray $BOT~HOTKEYS 255
  setarray $BOT~CUSTOM_KEYS 33
  setarray $BOT~CUSTOM_COMMANDS 33
  setvar $BOT~HOTKEYS[76] 9
  setvar $BOT~HOTKEYS[108] 9
  setvar $BOT~HOTKEYS[102] 14
  setvar $BOT~HOTKEYS[70] 14
  setvar $BOT~HOTKEYS[109] 13
  setvar $BOT~HOTKEYS[77] 13
  setvar $BOT~HOTKEYS[104] 5
  setvar $BOT~HOTKEYS[72] 5
  setvar $BOT~HOTKEYS[107] 1
  setvar $BOT~HOTKEYS[75] 1
  setvar $BOT~HOTKEYS[99] 2
  setvar $BOT~HOTKEYS[67] 2
  setvar $BOT~HOTKEYS[98] 17
  setvar $BOT~HOTKEYS[66] 17
  setvar $BOT~HOTKEYS[112] 7
  setvar $BOT~HOTKEYS[80] 7
  setvar $BOT~HOTKEYS[100] 11
  setvar $BOT~HOTKEYS[68] 11
  setvar $BOT~HOTKEYS[116] 6
  setvar $BOT~HOTKEYS[84] 6
  setvar $BOT~HOTKEYS[114] 3
  setvar $BOT~HOTKEYS[82] 3
  setvar $BOT~HOTKEYS[115] 4
  setvar $BOT~HOTKEYS[83] 4
  setvar $BOT~HOTKEYS[120] 12
  setvar $BOT~HOTKEYS[88] 12
  setvar $BOT~HOTKEYS[122] 15
  setvar $BOT~HOTKEYS[90] 15
  setvar $BOT~HOTKEYS[126] 16
  setvar $BOT~HOTKEYS[113] 8
  setvar $BOT~HOTKEYS[81] 8
  setvar $BOT~HOTKEYS[9] 10
  setvar $BOT~I 1
  while ($BOT~I <= 255)
    write $BOT~HOTKEYS_FILE $BOT~HOTKEYS[$BOT~I]
    add $BOT~I 1
  end
  ...
  setvar $BOT~I 1
  while ($BOT~I <= 33)
    write $BOT~CUSTOM_KEYS_FILE $BOT~CUSTOM_KEYS[$BOT~I]
    add $BOT~I 1
  end
  ...
  setvar $BOT~I 1
  while ($BOT~I <= 33)
    write $BOT~CUSTOM_COMMANDS_FILE $BOT~CUSTOM_COMMANDS[$BOT~I]
    add $BOT~I 1
  end
end
